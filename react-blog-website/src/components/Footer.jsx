          ...
          <div className='grid mb-8 lg:grid-cols-6'>
            ...
            <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                ...
                <form className='mt-4 flex flex-col md:flex-row'>
                  ...
                  <button type='submit' className='inline-flex items-center justify-center h-12 px-6 font-medium tracking-white text-white transition duration-200 rounded shadow-md hover:bg-orange-500 focus:outline-none border'> Subscribe </button>
                </form>
                <p className='mt-4 text-sm text-gray-500'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et veniam amet voluptatibus quae laboriosam maiores pariatur incidunt atque voluptatum expedita praesentium ipsam delectus debitis, deserunt dolor ducimus minima odio suscipit!</p>
            </div>
          </div>
