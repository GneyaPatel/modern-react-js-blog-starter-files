        ...
        <div className='bg-indigo-700 text-center p-5 h-96 lg:w-[500px] rounded shadow-md'>
          ...
          <form className='px-4'>
            {/*email*/}
              ...
              <div className='mb-5'>
                <input type='password' name='password' id='password' placeholder='Please enter your password' className='w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6a64f1] focus:shadow-md'/>
              </div>
              <div>
          ...
          {/*model close */}
          <button onClick={onClose} className='bg-gray-300 hover:bg-rary-400 text-gray-800 font-semibold py-2 px-8 rounded inline-flex item-center mt-5'>Close</button>
        </div>
      </div>
    </div>
  )
